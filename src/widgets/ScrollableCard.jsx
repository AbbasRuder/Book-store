...
export default function ScrollableCard(props) {
  ...
  return (
    <>
      <div class="min-w-[128px] max-w-[180px] py-3 px-2 grow bg-white shadow-lg rounded">
        <A href={`/${props.ISBN}`} class="relative">
          <img
            src={image}
            alt="book cover"
            class="w-26 h-52 mx-auto shadow shadow-black/70 rounded"
          />
        </A>
        ...
        <div class="ml-2 relative">
          ...
          {showCart() ? (
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              class="absolute top-0 right-0 w-8 h-8 float-right cursor-pointer text-green-400 bg-white rounded-full"
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              class="absolute top-0 bottom-0 right-0 w-8 h-8 float-right cursor-pointer text-red_primary bg-white rounded-full"
              onClick={addToCart}
            >
              <path
                fill-rule="evenodd"
