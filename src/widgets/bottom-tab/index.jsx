    ...
    <div class="fixed bottom-0 left-0 right-0 rounded-t-3xl bg-white shadow-2xl shadow-black">
      <div class="py-6 px-6 flex justify-around items-center">
        ...
        <div>
          {/* user icon */}
          <A href="/profile">
            <svg xmlns="http://www.w3.org/2000/svg" fill={`${currentTab() === "/profile" ? "#D45555" : "none"}`} stroke={`${currentTab() === "/profile" ? 'none' : "currentColor"}`} stroke-width="1.5" viewBox="0 0 24 24" class="w-7 h-7 cursor-pointer text-black_secondary">
